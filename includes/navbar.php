<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container">
    <a class="navbar-brand fw-bold" href="/tp_eg/index.php">Ofertópolis</a>
    ...
    <div class="collapse navbar-collapse" id="menu">
      <ul class="navbar-nav ms-auto">
        ...
        <?php else: ?>
          ...
          <?php endif; ?>
          <li class="nav-item"><a href="/tp_eg/auth/logout.php" class="nav-link text-danger">Cerrar sesión</a></li>
        <?php endif; ?>
      </ul>
    </div>
  </div>
